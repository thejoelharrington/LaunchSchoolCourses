...
class MySpacetruck < Vehicle
  ...
  def to_s
    "Your dino is a #{year} #{color} #{model}. You are going #{current_speed} paces per hour."
  end
end
...
myspaceship = MySpaceship.new('3042','black', 'futuristic lambo')
myspacetruck = MyDino.new('1,000,000bce', 'grey', 'brontosaurus')
puts myspaceship
puts myspacetruck.bites
